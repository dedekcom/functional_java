...
public interface TailRecursive {
  ...
  static <R> R tailRec(R initialResult, Function<R, FunTuple> fun) {
    Tuple6<Boolean, R, Object, Object, Object, Object> result = new Tuple6<>(true, initialResult, null, null, null, null);
    boolean continueLoop;
    do {
      FunTuple r = fun.apply(result._2());
      continueLoop = (Boolean)r._id(0);
      if (continueLoop) {
        result = (Tuple6<Boolean, R, Object, Object, Object, Object>)r;
      }
    } while (continueLoop);
    return result._2();
  }
  ...
  static <R> FunTuple Return(R result) {    return new Tuple6<>(false, result, null, null, null, null);  }

  static <R> FunTuple Continue(R result) {    return new Tuple6<>(true, result, null, null, null, null);  }

  static <R, T> FunTuple Continue(R result, T arg1) {  return new Tuple6<>(true, result, arg1, null, null, null);  }
